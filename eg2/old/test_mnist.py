"""
Test MNIST with the custom backend.
"""
...
def train(rank, world_size):
    register_backend()
    dist.init_process_group("comp", rank=rank, world_size=world_size)
    print("Using backend:", dist.get_backend())

    # Get current proess group
    pgroup = dist.distributed_c10d._get_default_group()
    print("Process group:", pgroup)
